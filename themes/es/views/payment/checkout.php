			...
			<table class="timetable_sub">
				<thead>
					...
					<tbody><tr class="rem1">
						...
						<td class="invert-image"><a href="single.html"><img src="<?php echo $themeBaseURL;?>images/w4.png" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
					...
					<tr class="rem2">
						...
						<td class="invert-image"><a href="single.html"><img src="<?php echo $themeBaseURL;?>images/ep3.png" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem3">
						...
						<td class="invert-image"><a href="single.html"><img src="<?php echo $themeBaseURL;?>images/w2.png" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem4">
						...
						<td class="invert-image"><a href="single.html"><img src="<?php echo $themeBaseURL;?>images/w1.png" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
